...
import { Search, Globe, BarChart3, Download, Upload } from "lucide-react"
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input value="https://yourdomain.com/sitemap.xml" readOnly />
                  <Button variant="outline" size="sm">
                    Copy
                  </Button>
                </div>
              ...
              <div>
                <h4 className="font-medium mb-2">Included Pages</h4>
