...
"[project]/app/admin-panel/earnings/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function EarningsManagement() {
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("sales");
    ...
    const [globalCommission, setGlobalCommission] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10);
    const [autoApproveWithdrawals, setAutoApproveWithdrawals] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const filteredVendors = vendors.filter((vendor)=>{
        ...
        switch(sortBy){
            case "sales":
                return parseFloat(b.totalSales.replace('$', '').replace(',', '')) - parseFloat(a.totalSales.replace('$', '').replace(',', ''));
            case "earnings":
                return parseFloat(b.adminEarnings.replace('$', '').replace(',', '')) - parseFloat(a.adminEarnings.replace('$', '').replace(',', ''));
            case "pending":
                return parseFloat(b.pendingWithdrawal.replace('$', '').replace(',', '')) - parseFloat(a.pendingWithdrawal.replace('$', '').replace(',', ''));
            case "commission":
    ...
    const handleApproveWithdrawal = (vendorId)=>{
        if (confirm("Approve this withdrawal request?")) {
            setVendors(vendors.map((vendor)=>vendor.id === vendorId ? {
                    ...vendor,
                    pendingWithdrawal: "$0",
                    totalWithdrawn: `$${(parseFloat(vendor.totalWithdrawn.replace('$', '').replace(',', '')) + parseFloat(vendor.pendingWithdrawal.replace('$', '').replace(',', ''))).toFixed(2)}`
                } : vendor));
            alert("Withdrawal approved and processed!");
        }
    };
    const handleRejectWithdrawal = (vendorId)=>{
    ...
    const handleExport = ()=>{
        const csvContent = "data:text/csv;charset=utf-8," + "Vendor,Total Sales,Commission,Admin Earnings,Pending Withdrawal,Status,Total Withdrawn\n" + filteredVendors.map((vendor)=>`${vendor.name},${vendor.totalSales},${vendor.commission}%,${vendor.adminEarnings},${vendor.pendingWithdrawal},${vendor.status},${vendor.totalWithdrawn}`).join("\n");
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                        ...
                        children: "Vendor Earnings & Withdrawals"
                    }, void 0, false, {
                        fileName: "[project]/app/admin-panel/earnings/page.tsx",
                        lineNumber: 201,
                        columnNumber: 9
                    }, this),
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        className: "text-muted-foreground mt-1",
                        children: "Manage commission and vendor payments"
                    }, void 0, false, {
                        fileName: "[project]/app/admin-panel/earnings/page.tsx",
                        lineNumber: 202,
                        columnNumber: 9
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        className: "admin-panel-table p-6",
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-sm text-muted-foreground mb-1",
                                            children: "Admin Commission Earned"
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin-panel/earnings/page.tsx",
                                            lineNumber: 219,
                                            columnNumber: 15
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("th", {
                                            className: "admin-panel-table-header-cell",
                                            children: "Vendor"
                                        }, void 0, false, {
                                            fileName: "[project]/app/admin-panel/earnings/page.tsx",
                                            lineNumber: 257,
                                ...
                                children: vendors.map((vendor)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "admin-panel-table-cell font-semibold",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "admin-panel-table-cell",
                                                children: vendor.totalSales
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin-panel/earnings/page.tsx",
                                                lineNumber: 268,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "admin-panel-table-cell text-green-600 font-bold",
                                                children: vendor.adminEarnings
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin-panel/earnings/page.tsx",
                                                lineNumber: 270,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                className: "admin-panel-table-cell text-orange-600 font-bold",
                                                children: vendor.pendingWithdrawal
                                            }, void 0, false, {
                                                fileName: "[project]/app/admin-panel/earnings/page.tsx",
                                                lineNumber: 271,
                                                columnNumber: 19
...
_s(EarningsManagement, "DyUd4OffqKzDaAZNxB18oTyozu8=");
_c = EarningsManagement;
var _c;
__turbopack_context__.k.register(_c, "EarningsManagement");
...
//# sourceMappingURL=_4d23ebbb._.js.map