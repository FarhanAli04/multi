...
"[project]/app/seller/layout.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function SellerLayout({ children }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SellerLayout.useEffect": ()=>{
            let cancelled = false;
            const check = {
                "SellerLayout.useEffect.check": async ()=>{
                    try {
                        const res = await fetch("/api/backend/auth/me");
                        const data = await res.json().catch({
                            "SellerLayout.useEffect.check": ()=>null
                        }["SellerLayout.useEffect.check"]);
                        if (cancelled) return;
    ...
    if (status !== "allowed") {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            fileName: "[project]/app/seller/layout.tsx",
            lineNumber: 58,
            columnNumber: 12
        }, this);
    }
...
_s(SellerLayout, "qskDtr0ypDootNWjCw1GpFZRjh4=", false, function() {
    return [
...
//# sourceMappingURL=_7b5e4b27._.js.map