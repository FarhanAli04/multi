...
async function POST(request) {
    try {
        ...
        if (!data) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Backend returned a non-JSON response. This usually means the PHP API crashed or printed warnings (missing vendor/autoload.php, DB config, etc).",
        ...
        if (apiResponse.status === 404) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: data?.error || `PHP backend route not found at ${apiBaseUrl}/api/auth/login. Verify XAMPP path + .htaccess rewrite.`
            }, {
                status: 503
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__31ac2f33._.js.map